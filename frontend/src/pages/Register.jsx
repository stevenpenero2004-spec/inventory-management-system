  ...
  return (
    <form className="space-y-4" onSubmit={submit}>
      <div className="text-center space-y-1">
        <div className="text-2xl font-bold text-gradient">Create account</div>
        <div className="text-sm text-gray-400">Join the inventory workspace</div>
      </div>
      ...
      <div className="space-y-2">
        ...
        <div className="relative">
          <input className="input pr-10" type={show ? 'text' : 'password'} placeholder="••••••••" value={form.password} onChange={e => setForm({ ...form, password: e.target.value })} />
          <button
            type="button"
      ...
      <div className="text-sm text-gray-400 text-center">Already have an account? <Link className="text-blue-400" to="/login">Sign in</Link></div>
    </form>
  )
}
