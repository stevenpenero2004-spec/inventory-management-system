  ...
  return (
    <form className="space-y-4" onSubmit={submit}>
      <div className="text-center space-y-1">
        <div className="text-2xl font-bold text-gradient">Welcome back</div>
        <div className="text-sm text-gray-400">Sign in to your account</div>
      </div>
      ...
      <div className="text-sm text-gray-400 text-center">No account? <Link className="text-blue-400" to="/register">Create one</Link></div>
    </form>
  )
}
